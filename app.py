...
col0.markdown("<h4 style='text-align: left; color: orange;'>%s</h4>"%('''Query Value for '%s':'''%(hist_col)), unsafe_allow_html=True)
...
col0.markdown("<h3 style='text-align: center; color: orange;'>%s</h3>"%('''%s'''%( content)), unsafe_allow_html=True)
