...
st.markdown("<h3 style='text-align: center; color: Black;'>Low Yun Kai</h3>", unsafe_allow_html=True)
...
col1.markdown("<h4 style='text-align: center; color: orange;'>%s</h4>"%('''Query Value:'''), unsafe_allow_html=True)
...
if hist_col not in num_cols:
    ...
    _, col1a,___, col1b, __ = col1.columns([1,4,1,6,1])
    ...
    col1a.markdown("<h4 style='text-align: center; color: grey;'>%s</h4>"%(hist_col), unsafe_allow_html=True)
    ...
    if iscat:
        ...
        col1b.markdown("<h4 style='text-align: center; color: grey;'>%s</h4>"%(ori_name), unsafe_allow_html=True)
